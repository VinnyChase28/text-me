export const styles = {
  ...
  queryResponse:
    "pt-6 text-2xl text-blue-500 flex justify-center items-center w-full",
  cardSection:
    "flex flex-col justify-center p-6 duration-500 border-2 border-gray-500 rounded shadow-xl motion-safe:hover:scale-105",
